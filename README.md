...
|---------|--------------|
[![Build Status](https://dev.azure.com/ShitlhRP/myApp/_apis/build/status/peckson.pipelines-javascript)](https://dev.azure.com/ShitlhRP/myApp/_build/latest?definitionId=2)
